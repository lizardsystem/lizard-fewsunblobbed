...
def fews_symbol_name(
    fews_filter, fews_location, fews_parameter, nodata=False,
    ...
    style_name, icon_style = IconStyle.style(
        fews_filter, fews_location, fews_parameter, styles, lookup)
...
def fews_point_style(
    ...
    point_style_name, output_filename = fews_symbol_name(
        fews_filter, fews_location, fews_parameter, nodata, styles, lookup)
